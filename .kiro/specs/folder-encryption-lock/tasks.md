...
Requirements: All
 2. Implement encryption engine core
...
Requirements: 1.3, 5.1, 5.4
 2.1 Write property test for AES-256 CBC with random IV

Property 8: AES-256 CBC with Random IV
Validates: Requirements 5.4
 2.2 Write property test for PBKDF2 key derivation parameters

Property 5: PBKDF2 Key Derivation Parameters
Validates: Requirements 5.1
 3. Implement password handling and verification
...
Requirements: 5.1, 5.2, 5.3
 3.1 Write property test for password storage security

Property 6: Password Storage Security
Validates: Requirements 5.2
 3.2 Write property test for password verification before decryption

Property 7: Password Verification Before Decryption
Validates: Requirements 5.3
 4. Implement folder registry with SQLite database
...
Requirements: 1.4, 3.3, 7.1
 4.1 Write property test for folder registry consistency

Property 2: Folder Registry Consistency
Validates: Requirements 1.4
 4.2 Write property test for service initialization loads all entries

Property 4: Service Initialization Loads All Entries
Validates: Requirements 3.3
 4.3 Write unit tests for folder registry operations

Test adding, retrieving, updating, and removing locked folder entries
Test database initialization and schema creation
Requirements: 1.4, 7.1
 5. Implement file system operations with backup and rollback
...
Requirements: 6.1, 6.2, 8.1, 8.4, 8.5
 5.1 Write property test for backup creation before encryption

Property 9: Backup Creation Before Encryption
Validates: Requirements 6.1
 5.2 Write property test for rollback on encryption failure

Property 10: Rollback on Encryption Failure
Validates: Requirements 6.2
 5.3 Write property test for recursive subfolder encryption
...
Requirements: 1.3, 1.4, 6.1, 6.2, 8.1, 8.2
...
Requirements: 2.2, 2.3, 6.3, 6.4, 6.5, 8.3, 8.5
 8. Checkpoint - Core encryption functionality complete

All core encryption/decryption tests passing
Property-based tests validating correctness properties
 9. Create WPF GUI application project
...
Requirements: 1.1, 7.1
 10. Implement main window UI and folder management
...
Requirements: 1.1, 1.2, 1.3, 1.4, 1.5, 2.2, 2.3, 7.1, 7.2, 7.3, 7.4, 7.5
